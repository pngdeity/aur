# Nathan's AUR Packages

Package sources for all the AUR packages I officially [maintain](https://aur.archlinux.org/packages/?SeB=m&K=pngdeity), [co-maintain](https://aur.archlinux.org/packages/?SeB=c&K=pngdeity), or unofficially host modified versions of.

## Pacman Package Repository -> TODO

To use my Pacman package repository, first add [my GPG key](https://pgp.mit.edu/pks/lookup?op=get&search=0x63CC496475267693) to your Pacman keyring:
